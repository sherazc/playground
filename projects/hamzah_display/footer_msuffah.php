<style>
    .footer {
        ...
        /*background-color: rgba(42, 24, 9, 0.81);*/
        /*color: #f7f7f7;*/
    }
    .footer > div {
        display: table-cell;
    ...
    .footer_bg_curve_left {
        ...
        background: transparent url("images/msuffah/footer_trangle_left.png") top center no-repeat;
        width: 125px;
    }
    .footer_bg_curve_right {
        /*background: transparent url("images/footer_curve_right.png") top center no-repeat;*/
        background: transparent url("images/msuffah/footer_trangle_right.png") top center no-repeat;
        width: 125px;
    }
...
<!--    <div class = "footer_corner_fixed footer_bg_corner_repeat">-->
<!--    </div>-->

    <div class = "footer_corner_fixed footer_bg_curve_left">
    ...
    <div class = "footer_corner_fixed footer_bg_curve_right">
