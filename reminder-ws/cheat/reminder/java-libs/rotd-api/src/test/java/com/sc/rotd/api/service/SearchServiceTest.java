...
public class SearchServiceTest {
    ...
    public void testSearchZeroHistory() throws Exception {
        List<AyaDetail> ayaDetails = searchService.search(0, "English_-_Abdullah_Yusuf_Ali");
    ...
    public void testSearch10History() throws Exception {
        List<AyaDetail> ayaDetails = searchService.search(10, "English_-_Abdullah_Yusuf_Ali");
        Assert.assertNotNull(ayaDetails);
