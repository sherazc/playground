    ...
    <div class="progress_container">
        ...
        ?>
            <table border="1" class="fund_table">
                <tr>
                    <th><?php printConfig("fund_target", "Target"); ?></th>
                    <td>$<?= number_format($fundA->target, 2) ?></td>
                </tr>
                <tr>
                    <th><?php printConfig("fund_end_date", "End Date"); ?></th>
                    <td> <?= date ("m/d/Y", strtotime($fundA->end_date)) ?></td>
                </tr>
                <tr>
                    <th><?php printConfig("fund_remaining", "Remaining"); ?></th>
                ...
                <tr style="display: none">
                    ...
                    ?>
                    <th style="color: tomato"><?php printConfig("fund_pledge", "Pledge"); ?></th>
                    <td style="color: tomato">$<?= number_format($fundA->pledge, 2) ?></td>
                </tr>
                <tr>
                    <th><?php printConfig("fund_collected", "Collected"); ?></th>
