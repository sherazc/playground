...
<body>
<?php
if (config("clock_type", 1) == "1") {
    include 'analog_clock.php';
} else if (config("clock_type", 1) == "2") {
            ...
            <div id="hadith_weather_container" class="side_column center-block">
                <div style="top: 100px; left: 0px; position: relative;">
                    <div class="headingBig" style="text-align: center;">
                        <?php printConfig("reminder_title", "Reminders"); ?>
                    </div>
<script>

    <?php
    $event_slide_delay_seconds = config("event_slide_delay_seconds", "30");
    ?>
    $(function(){
        function showQuranHadith(){
            $("#quran_hadith_container").slideDown(1500).delay(<?php pv($event_slide_delay_seconds); ?> * 1000).slideUp(1500, function(){
                showEvents();
            });
        }

        function showEvents(){
            $("#events_container").slideDown(1500).delay(<?php pv($event_slide_delay_seconds); ?> * 1000).slideUp(1500, function(){
                showQuranHadith();
            });
        }
...
<div id="quran_hadith_container">
    <?php include "quran_hadith.php"; ?>
</div>
