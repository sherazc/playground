...
public class Nio08TransferFrom {
	public static void main(String[] args) throws Exception {
		MyFileUtils.cleanCache();
		Path pathFrom = MyFileUtils.createFile("./in/file_from.txt", "abcd xyz 123456");
		...
		fileChannelTo.transferFrom(fileChannelFrom, fileChannelTo.size(), fileChannelTo.size());
